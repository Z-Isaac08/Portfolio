    ...
    return (
        <header className='flex items-center justify-between m-auto top-0 sticky p-4 w-4/5'>
            ...
            <div className='flex items-center space-x-4'>
                <Link to='https://github.com/Isaac1676' target='_blank' rel='noopener noreferrer'>
                    <FontAwesomeIcon icon={faGithub} className='text-foreground h-6 w-6 md:h-8 md:w-8' />
                </Link>
                <Link to='https://www.linkedin.com/in/isaac-n-cho-6a9a2a282?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app' target='_blank' rel='noopener noreferrer'>
